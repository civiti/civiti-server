...
{
    /// <inheritdoc />
    public partial class AddOpenIddictAndMcpSessions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenIddictTokenId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "McpSessions",
                columns: new[] { "SupabaseUserId", "RevokedAt" });
