    ...
    ILogger<StaticDataSeeder> logger) : IHostedService
{
    ...
    private async Task SeedBadgesAsync(CivitiDbContext context, CancellationToken cancellationToken)
    {
    ...
    private async Task SeedAchievementsAsync(CivitiDbContext context, CancellationToken cancellationToken)
    {
    ...
    private async Task SeedAuthoritiesAsync(CivitiDbContext context, CancellationToken cancellationToken)
    {
