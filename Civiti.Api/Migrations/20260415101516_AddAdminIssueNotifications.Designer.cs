...
namespace Civiti.Api.Migrations
{
    ...
    [Migration("20260415101516_AddAdminIssueNotifications")]
    partial class AddAdminIssueNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Civiti.Api.Models.Domain.AdminIssueNotification", b =>
                {
                    b.Property<Guid>("IssueId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Civiti.Api.Models.Domain.PushToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Civiti.Api.Models.Domain.AdminIssueNotification", b =>
                {
                    b.HasOne("Civiti.Api.Models.Domain.Issue", null)
                        .WithMany()
                        .HasForeignKey("IssueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
